...
function getPublicAccountID(accountPublicKeyBytes, prefix = 'ffd') {
...
function isValidAccount(account: string): boolean {
  return nanocurrency.checkAddress(account.replace('ffd_', 'nano_'));
}
